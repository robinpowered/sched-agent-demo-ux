...
const getRoomImage = (roomId: string): string => {
  ...
  const roomImages: Record<string, string> = {
    ...
    "conf-b":
      "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=400&h=250&fit=crop&crop=center",
    "conf-c":
      "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=400&h=250&fit=crop&crop=center",
    "huddle-1":
      "https://images.unsplash.com/photo-1523908511403-7fc7b25592f4?w=400&h=250&fit=crop&crop=center",
    "focus-room-1":
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=400&h=250&fit=crop&crop=center",
    "creative-space-1":
      "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=400&h=250&fit=crop&crop=center",
    "board-room":
      "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=400&h=250&fit=crop&crop=center",
    "training-room":
      "https://images.unsplash.com/photo-1540317580384-e5d43616b9aa?w=400&h=250&fit=crop&crop=center",
    "small-meeting-1":
      "https://images.unsplash.com/photo-1556761175-4b46a572b786?w=400&h=250&fit=crop&crop=center",
    "executive-suite":
      "https://images.unsplash.com/photo-1543269865-cbf427effbad?w=400&h=250&fit=crop&crop=center",
    "collaboration-hub":
      "https://images.unsplash.com/photo-1517502884422-41eaead166d4?w=400&h=250&fit=crop&crop=center",
    "innovation-lab":
...
export function RoomBookingSuggestions({
  ...
  useEffect(() => {
    const findRoomSuggestions = () => {
      ...
      if (!Array.isArray(rooms)) {
        console.error(
          "RoomBookingSuggestions: rooms prop is not an array",
          rooms
        );
        return;
      }
      ...
      const availableRooms = rooms
        ...
        .map((room) => {
          ...
          if (
            ...
            featureMatches === requiredFeatures.length
          ) {
            score += 20;
          }
      ...
      const haveSuggestionsChanged =
        availableRooms.length !== suggestions.length ||
        availableRooms.some(
          (room, index) => room.roomId !== suggestions[index]?.roomId
        );
      ...
      <Card className={`p-4 bg-red-50 border-red-200 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-sm text-red-600">
            No rooms are available for your requirements. Try adjusting the
            time, capacity, or features needed.
          </p>
        </div>
      </Card>
    );
  ...
  const displayAmenities = currentSuggestion.roomFeatures
    .filter((f) => amenityIcons.some((a) => f.includes(a)))
    .slice(0, 3);
  const totalAmenities = currentSuggestion.roomFeatures.length;

  return (
    <div
      className={`content-stretch flex flex-col items-start relative rounded-[8px] w-full ${className}`}
    >
      <div
        aria-hidden="true"
        ...
        <div className="flex flex-row items-center size-full">
          <div className="box-border content-stretch flex items-center justify-between px-[12px] py-[8px] relative w-full border-b border-[#d6d6d6]">
            <div className="flex flex-col font-['Brown_LL',_sans-serif] h-[22px] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#1c1c1c] text-[14px] text-nowrap">
              <p className="[white-space-collapse:collapse] leading-[22px] overflow-ellipsis overflow-hidden font-medium">
                Book Space
              </p>
            </div>
        ...
        <div className="size-full">
          <div className="box-border content-stretch flex flex-col gap-[10px] items-start p-[12px] relative w-full">
            ...
            <div className="relative rounded-[8px] shrink-0 w-full">
                        ...
                        <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0">
                          ...
                          <div className="content-center flex flex-wrap gap-[4px] items-center relative shrink-0 w-full mt-1">
                            <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                              ...
                              {currentSuggestion.roomFeatures.some(
                                (f) =>
                              ...
                              {currentSuggestion.roomFeatures.some((f) =>
                              ...
                              {totalAmenities > 0 && (
                                <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0">
                                  <div
                                    aria-hidden="true"
                                    className="absolute border-[#a1a1a1] border-[0px_0px_1px] border-dashed inset-0 pointer-events-none"
                                  />
              ...
              <div
                aria-hidden="true"
                className="absolute border border-[#e693b8] border-solid inset-0 pointer-events-none rounded-[8px]"
              />
            </div>
          </div>
        </div>
